...
internal class RegisterVehicleHandlerTest {
    ...
    private val handler: RegisterVehicleHandler = RegisterVehicleHandler(mockVehicleRepository, mockUniqueValidator)

    @Test
    fun `should register Vehicle's`() {
        val vehicle = VehicleBuilder().build()
        val command = RegisterVehicleCommand(
